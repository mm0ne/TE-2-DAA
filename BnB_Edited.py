...
def find_maxdeg(g):
    ...
    deglist_sorted = sorted(deglist, reverse=True, key=operator.itemgetter(1))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-time", action="store", default=1000, type=int, required=True, help="Cutoff running time for algorithm"
    )
